...
namespace LiveForensics.Symbols
{
	...
	public class CatalogueInformation
	{
		 ...
		 public string Contents { get { return @"[""_EPROCESS"",""_KUSER_SHARED_DATA"",""_OBJECT_TYPE"",""_OBJECT_HEADER"",""_OBJECT_DIRECTORY_ENTRY"",""_OBJECT_DIRECTORY"",""_OBJECT_HEADER_CREATOR_INFO"",""_OBJECT_HEADER_NAME_INFO"",""_OBJECT_HEADER_HANDLE_INFO"",""_OBJECT_HEADER_QUOTA_INFO"",""_OBJECT_HEADER_PROCESS_INFO"",""_OBJECT_HEADER_AUDIT_INFO"",""_KPROCESS"",""_EX_PUSH_LOCK"",""_LARGE_INTEGER"",""_UNNAMED_27161"",""_EX_RUNDOWN_REF"",""_LIST_ENTRY"",""_EX_FAST_REF"",""_RTL_AVL_TREE"",""_SE_AUDIT_PROCESS_CREATION_INFO"",""_MMSUPPORT"",""_ALPC_PROCESS_CONTEXT"",""_PS_PROTECTION"",""_KSYSTEM_TIME"",""_XSTATE_CONFIGURATION"",""_UNICODE_STRING"",""_OBJECT_TYPE_INITIALIZER"",""_QUAD"",""_OBJECT_HANDLE_COUNT_ENTRY"",""_DISPATCHER_HEADER"",""_KAFFINITY_EX"",""_SINGLE_LIST_ENTRY"",""_KEXECUTE_OPTIONS"",""_KSTACK_COUNT"",""_KGDTENTRY64"",""_UNNAMED_27362"",""_FAST_MUTEX"",""_UNNAMED_27364"",""_MMSUPPORT_FLAGS"",""_XSTATE_FEATURE"",""_GENERIC_MAPPING"",""_KEVENT""])"; } }
		 public string Created { get { return "16-04-2017T14:06:06"; } }
	}
	#endregion
	#region _EPROCESS
	...
	public class _LARGE_INTEGER
	{
		...
		public _UNNAMED_27161 u
		{
			get
			{
				_UNNAMED_27161 returnValue = new _UNNAMED_27161(_StructureData, _BufferOffset + 0);
				return returnValue;
			}
		}
	...
	#endregion
	#region _UNNAMED_27161
 
	public class _UNNAMED_27161
	{
		private Byte[] _StructureData;
		private int _BufferOffset;
		public _UNNAMED_27161(Byte[] Buffer, int PartitionOffset)
		{
			_StructureData = Buffer;
			_BufferOffset = PartitionOffset;
		}
	...
	public class _KGDTENTRY64
	{
		...
		public string manifest
		{
			get
			{
				return @"(
				{
				 ...
				 ""Bytes"": [ 4, [ ""_UNNAMED_27362"", ""null"" ]],
				 ""Bits"": [ 4, [ ""_UNNAMED_27364"", ""null"" ]],
		...
		public _UNNAMED_27362 Bytes
		{
			get
			{
				_UNNAMED_27362 returnValue = new _UNNAMED_27362(_StructureData, _BufferOffset + 4);
				return returnValue;
			}
		}
		public _UNNAMED_27364 Bits
		{
			get
			{
				_UNNAMED_27364 returnValue = new _UNNAMED_27364(_StructureData, _BufferOffset + 4);
				return returnValue;
			}
		}
	...
	#endregion
	#region _UNNAMED_27362
 
	public class _UNNAMED_27362
	{
		private Byte[] _StructureData;
		private int _BufferOffset;
		public _UNNAMED_27362(Byte[] Buffer, int PartitionOffset)
		{
			_StructureData = Buffer;
			_BufferOffset = PartitionOffset;
		}
	...
	#endregion
	#region _UNNAMED_27364
 
	public class _UNNAMED_27364
	{
		private Byte[] _StructureData;
		private int _BufferOffset;
		public _UNNAMED_27364(Byte[] Buffer, int PartitionOffset)
		{
			_StructureData = Buffer;
			_BufferOffset = PartitionOffset;
		}
